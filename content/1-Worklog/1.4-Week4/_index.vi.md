...
| --- | --------- | ------------ | --------------- | -------------- |
|  2  | - Học Amazon S3 (Storage Class, Access Point, Versioning, Static Website, CORS, Glacier), Snow Family, Storage Gateway, Disaster Recovery (RTO/RPO) và AWS Backup | 11/05/2026 | 11/05/2026 | <https://youtu.be/_yunukwcAwc> <br> <https://youtu.be/mPBjB6Ltl_Q> <br> <https://youtu.be/YXn8Q_Hpsu4> |
|  3  | - Xây dựng VPC Multi-AZ, cấu hình bảo mật mạng (SG, NACLs), NAT Gateway, VPC Flow Logs, Session Manager và thiết lập kết nối Site-to-Site VPN | 12/05/2026 | 12/05/2026 | <https://000003.awsstudygroup.com/> |
