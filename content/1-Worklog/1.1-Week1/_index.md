...
* Understand an overview of AWS and its main service categories, and get familiar with the AWS Management Console and AWS CLI.
...
* **Cost Management (AWS Budgets - Setup Process)**
    ...
    * **Create Usage Budget**
        ...
        * ![Proof: Select AWS Billing and Cost Management service](/images/1-Worklog/1.1-Week1/Day6/AWS_Billing_and_Cost_Management.png)
        * In the management dashboard, select "Budgets" from the left menu. Click "Create budget".
        * ![Proof: Create a budget](/images/1-Worklog/1.1-Week1/Day6/Create_a_budget.png)
        * Select "Customize".
        * Under "Budget types", select "Usage budget".
        * Click "Next".
        * ![Proof: Budget setup](/images/1-Worklog/1.1-Week1/Day6/Budget_setup.png)
        ...
        * ![Proof: Budgeting Details](/images/1-Worklog/1.1-Week1/Day6/Details_Budget.png)
        ...
        * ![Proof: Set budget amount](/images/1-Worklog/1.1-Week1/Day6/Set_budget_amount.png)
        * In the "Budget scope" section, keep the default and click "Next".
        * ![Proof: Budget scope](/images/1-Worklog/1.1-Week1/Day6/Budget_scope.png)
        * In the "Configure alerts" section, select "Add an alert threshold".
        * ![Proof: Set up alert threshold](/images/1-Worklog/1.1-Week1/Day6/Add_an_alert_threshold.png)
        * Set the alert threshold (% of budget).
        * Add an email address to receive notifications when the threshold is exceeded.
        * ![Proof: Alert configuration](/images/1-Worklog/1.1-Week1/Day6/Alert.png)
        * Click "Next" to continue.
        * ![Proof: Review settings](/images/1-Worklog/1.1-Week1/Day6/Check_Alert.png)
        * Review settings and click "Create budget" to finish.
        * ![Proof: Create budget](/images/1-Worklog/1.1-Week1/Day6/Create_budget.png)
        * Once successfully created, you will see the new budget in the list.
        * ![Proof: Usage budget successfully created](/images/1-Worklog/1.1-Week1/Day6/Tạo_Usage_budget_thành_công.png)
        * Check "Budget health" to monitor current usage against the established budget.
        * ![Proof: Budget health](/images/1-Worklog/1.1-Week1/Day6/Budget_health.png)
        * View "Budget history" to track usage trends over time.
        * ![Proof: Budget history](/images/1-Worklog/1.1-Week1/Day6/Budget_history.png)
    ...
    * **Create RI & Savings Plans Budget**
        ...
        * Click "Next".
        * ![Proof: Budget setup](/images/1-Worklog/1.1-Week1/Day6/Budget_setup_3.png)
        * Enter the budget name.
        * ![Proof: Budget name](/images/1-Worklog/1.1-Week1/Day6/Budget_name.png)
        * Configure the "Coverage threshold".
        * ![Proof: Coverage threshold](/images/1-Worklog/1.1-Week1/Day6/Coverage_threshold.png)
        * Configure the "Budget scope".
        * ![Proof: Budget scope](/images/1-Worklog/1.1-Week1/Day6/Budget_scope.png)
        * In the "Alert setting" section, enter the email address. Click "Next".
        * ![Proof: Alert setting](/images/1-Worklog/1.1-Week1/Day6/Alert_setting.png)
        * Click "Create budget".
        * ![Proof: Create RI budget](/images/1-Worklog/1.1-Week1/Day6/Create_RI_budget.png)
        * Budget creation complete.
        * ![Proof: RI budget successfully created](/images/1-Worklog/1.1-Week1/Day6/Tạo_RI_Budget_thành_công.png)
        * Verify the created budget.
        * ![Proof: Check RI budget](/images/1-Worklog/1.1-Week1/Day6/Check_RI_budget.png.png)
    ...
    * **Configure Alerts & Email Notifications**
        ...
        * ![Proof: Budgeting Details](/images/1-Worklog/1.1-Week1/Day6/Details_saving_plan_budget.png)
        * In "Budget scope", keep the default options. Click "Next".
        * ![Proof: Budget scope](/images/1-Worklog/1.1-Week1/Day6/Budget_scope.png)
        * In the "Alert setting" section, enter the email address. Click "Next".
        * ![Proof: Alert setting](/images/1-Worklog/1.1-Week1/Day6/Alert_setting.png)
        * Review the settings and click "Create budget" to finish.
        * ![Proof: Create Savings Plan budget](/images/1-Worklog/1.1-Week1/Day6/Create_saving_plan_budget.png)
        * Upon successful creation, a confirmation message will appear.
        * Check the details of the created budget in the budget list.
        * ![Proof: Savings Plan budget successfully created](/images/1-Worklog/1.1-Week1/Day6/Tạo_saving_plan_Budget_thành_công.png)
    ...
    * **Resource Cleanup**
        ...
        * ![Proof: Delete budget](/images/1-Worklog/1.1-Week1/Day6/Delete_budget.png)
...
* **Create Admin Group:**
    ...
    * ![Proof: AWS Management Console](/images/1-Worklog/1.1-Week1/Day2/AWS_Management_Console.png)
    * Use the Search bar on AWS Management Console
    * Enter “IAM”
    * Select IAM service from the search results
    * ![Proof: Search IAM](/images/1-Worklog/1.1-Week1/Day2/Search_bar.png)
    * In the left navigation pane, select User Groups and click Create Group
    * ![Proof: Create Group](/images/1-Worklog/1.1-Week1/Day2/Create_Group.png)
    * In the Name the group section, enter the group name (e.g., AdminGroup)
    * ![Proof: Name the group](/images/1-Worklog/1.1-Week1/Day2/Name_the_group.png)
    * Search for AdministratorAccess
    * Select policy AdministratorAccess from the list
    * Click Create Group
    * ![Proof: Attach permissions policies](/images/1-Worklog/1.1-Week1/Day2/Attach_permissions_policies.png)
    * Confirm the Admin Group creation has been completed successfully
    * ![Proof: Admin Group created successfully](/images/1-Worklog/1.1-Week1/Day2/Admin_group_created.png)

* **Create Admin User:**
    * Create a new user, set a custom password.
    * Add the user to the `admin` group to inherit permissions.
    * ![Proof: Create Admin User](/images/1-Worklog/1.1-Week1/Day2/Create_Admin_User.png)
    * ![Proof: User details](/images/1-Worklog/1.1-Week1/Day2/Specify_user_details_1.png)
    * ![Proof: User details](/images/1-Worklog/1.1-Week1/Day2/Specify_user_details_2.png)
    * ![Proof: Permissions Options](/images/1-Worklog/1.1-Week1/Day2/Set_permissions.png)
    * ![Proof: Review and create](/images/1-Worklog/1.1-Week1/Day2/Review_and_create.png)
    * ![Proof: Retrieve password](/images/1-Worklog/1.1-Week1/Day2/Retrieve_pasword.png)
    * ![Proof: Download .csv file](/images/1-Worklog/1.1-Week1/Day2/Dowload_csv_file.png)
    * ![Proof: Admin User created successfully](/images/1-Worklog/1.1-Week1/Day2/Create_adminuser_success.png)
...
* **Login and Check:**
    ...
    * ![Proof: Access URL](/images/1-Worklog/1.1-Week1/Day2/Truy_cập_URL.png)
    * Open an Incognito/Private browser window
    * ![Proof: Incognito/Private](/images/1-Worklog/1.1-Week1/Day2/Đăng_nhập_ẩn_danh.png)
    * Enter Account ID or alias (if any)
    * Enter IAM Username
    * Enter temporary password from the .csv file
    * Follow instructions to change password
    * ![Proof: Change password](/images/1-Worklog/1.1-Week1/Day2/Thay_đổi_mật_khẩu.png)
    * Confirm successful login
    * ![Proof: Admin User logged in successfully](/images/1-Worklog/1.1-Week1/Day2/Đăng_nhập_thành_công.png)
    * Check Administrator permissions
    * ![Proof: Check Admin permissions](/images/1-Worklog/1.1-Week1/Day2/Kiểm_tra_quyền.png)
...
* **Create Admin Role:**
    ...
    * ![Proof: Initialize Role](/images/1-Worklog/1.1-Week1/Day2/Create_Role.png)
    * Select AWS account
    * This option allows the role to be used within the current AWS account or another account
    * ![Proof: Select trusted entity](/images/1-Worklog/1.1-Week1/Day2/Select_trusted_entity.png)
    ...
    * Click Next
    * ![Proof: Add permissions](/images/1-Worklog/1.1-Week1/Day2/Add_permissions.png)
    * Enter role name (e.g., AdminRole)
    * Add a detailed description of the role's purpose
    * ![Proof: Role name](/images/1-Worklog/1.1-Week1/Day2/Role_name.png)
    * Review configuration and click Create role
    * ![Proof: Add tag](/images/1-Worklog/1.1-Week1/Day2/Add_tag.png)
    * Confirm role creation was successful
    * ![Proof: Role created successfully](/images/1-Worklog/1.1-Week1/Day2/Tạo_role_thành_công.png)
    * Check detailed information of the newly created role
    * ![Proof: View Role information](/images/1-Worklog/1.1-Week1/Day2/Kiểm_tra_role.png)
...
* **Create Operator User:**
    ...
    * Click Add Users
    * ![Proof: Create Operator User](/images/1-Worklog/1.1-Week1/Day2/Create_Admin_User.png)
    ...
    * ![Proof: User information](/images/1-Worklog/1.1-Week1/Day2/thông_tin_User.png)
    * Click Next to continue
    * ![Proof: Skip permissions](/images/1-Worklog/1.1-Week1/Day2/Pass_permission.png)
    ...
    * ![Proof: Skip tag](/images/1-Worklog/1.1-Week1/Day2/Pass_add_tag.png)
    * Store login information securely
    * Prepare for assume role configuration
    * ![Proof: OperatorUser created successfully](/images/1-Worklog/1.1-Week1/Day2/Tạo_OperatorUser_thành_công.png)
...
* **Allow OperatorUser to switch role**
    ...
    * Click Users.
    * Click OperatorUser.
    * ![Proof: Select Role](/images/1-Worklog/1.1-Week1/Day2/Chọn_role.png)
    * Click Add inline policy.
    * ![Proof: Create inline policy](/images/1-Worklog/1.1-Week1/Day2/Add_inline_policy.png)
    ...
    * Click Review Policy.
    * ![Proof: Policy editor](/images/1-Worklog/1.1-Week1/Day2/Policy_editor.png)
    * Name the inline policy AllowSwitchAdminPolicy.
    * Click Create Policy.
    * ![Proof: Create Policy](/images/1-Worklog/1.1-Week1/Day2/Create_Policy.png)
...
* **Login OperatorUser**
    ...
    * ![Proof: Enter OperatorUser](/images/1-Worklog/1.1-Week1/Day2/Vào_operatoruser.png)
    ...
    * Enter login information:
        ...
        * Provided password
    * Click Sign in
    * ![Proof: Login OperatorUser](/images/1-Worklog/1.1-Week1/Day2/Đn_role_operator.png)
    ...
    * ![Proof: Check status](/images/1-Worklog/1.1-Week1/Day2/Xác_nhận_trạng_thái.png)
...
* **Switch Role**
    ...
    * Select Switch Roles
    * ![Proof: Switch Role operation](/images/1-Worklog/1.1-Week1/Day2/Switch_role.png)
    ...
    * ![Proof: Switch role information](/images/1-Worklog/1.1-Week1/Day2/Thông_tin_chuyển_role.png)
    ...
    * ![Proof: Switch role successful](/images/1-Worklog/1.1-Week1/Day2/Chuyển_role_thành_công.png)
...
* **Cleanup**
    ...
    * Click Delete
    * ![Proof: Delete IAM User](/images/1-Worklog/1.1-Week1/Day2/Xóa_IAM_User.png)
    * Carefully check the user information to be deleted
    * Enter user name to confirm
    * Click Delete to complete
    * ![Proof: Confirm delete IAM User](/images/1-Worklog/1.1-Week1/Day2/Xác_nhận_xóa_IAM_User.png)
    * Return to IAM service
    * Select User groups
    * Select group related to the lab
    * Click Delete
    * ![Proof: Delete IAM User Group](/images/1-Worklog/1.1-Week1/Day2/Xóa_IAM_User_Group.png)
    * Carefully check the group information to be deleted
    * Click Delete to complete
    * ![Proof: Confirm delete IAM User Group](/images/1-Worklog/1.1-Week1/Day2/Xác_nhận_xóa_IAM_User_Group.png)
