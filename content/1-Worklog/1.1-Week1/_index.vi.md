...
* **Kết nối & Hội nhập:** Làm quen với cộng đồng First Cloud Journey, nắm vững nội quy chương trình và hoàn tất thiết lập môi trường làm việc (AWS Free Tier)
* **Quản trị & Bảo mật cơ bản:** Hiểu và thực hành thiết lập AWS Budgets để kiểm soát chi phí, cùng với AWS IAM để quản lý quyền truy cập (User, Group, Role, Policy)
* **Nền tảng hạ tầng AWS:** Nắm vững kiến thức tổng quan về hạ tầng toàn cầu của AWS và các nhóm dịch vụ cốt lõi: Compute, Storage, Database
* **Mạng & Công cụ quản lý:** Hiểu sâu về Networking với Amazon VPC và thành thạo cách tương tác với hệ thống qua AWS Management Console cùng AWS CLI
