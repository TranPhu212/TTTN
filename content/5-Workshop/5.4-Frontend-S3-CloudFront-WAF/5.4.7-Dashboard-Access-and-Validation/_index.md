...
The HTTP response check confirms that the CloudFront URL returns a successful response. Redacted identifiers in headers are not required for the workshop.
...
![API behavior placeholder](/fcaj-internship-report/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-26-api-behavior-placeholder.png)
