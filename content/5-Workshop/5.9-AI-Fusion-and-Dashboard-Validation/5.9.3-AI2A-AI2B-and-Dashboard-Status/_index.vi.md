...
AI2A và AI2B được giữ ở mức integration placeholder nếu chưa có final model artifact và backend integration evidence. Dashboard phải thể hiện rõ đang dùng mock, replay hay real API mode.
