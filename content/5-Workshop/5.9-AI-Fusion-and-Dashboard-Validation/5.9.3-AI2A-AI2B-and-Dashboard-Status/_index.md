...
AI2A and AI2B are kept as integration placeholders unless final model artifacts and backend integration evidence are available. The dashboard must make mock, replay, or real API mode visible.
...
The real API environment screenshot is redacted and should only be used to explain how the endpoint is configured, not to expose private domains or tokens.

![Frontend real API environment redacted](/fcaj-internship-report/images/5-Workshop/5.9-AI-Fusion-and-Dashboard-Validation/w-phu-45-frontend-env-real-api-redacted.png)
